...
//
//     protected _createSender(): IMessageSender {
//         return {} as IMessageSender;
//         // return new RabbitMqSender(this._config, this._logger); // todo inject as we do in Server
//     }
//
//     protected _createHandler(): IMessageHandler {
//         return {} as IMessageHandler;
//         // return new RabbitMqReceiver(this._config, this._logger); // todo inject as we do in Server
//     }
//
//     shutdown() {
//
