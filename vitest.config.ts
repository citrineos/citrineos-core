...
export default defineConfig({
  test: {
    ...
    reporters: process.env.CI
      ...
      : ['default'],
    // Coverage denominator: hand-written runtime code only. Excluded on purpose:
    // packages/types (generated by json-schema-to-typescript plus declarative
    // zod/type files), apps/operator-ui (covered by the Playwright e2e lanes),
    // apps/ocpp-server + apps/ocpi-server (composition-root glue covered by the
    // e2e lanes and the server build workflow).
    coverage: {
      provider: 'v8',
