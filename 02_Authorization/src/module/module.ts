...
export class AuthorizationModule extends AbstractModule {
  ...
  /**
   * This is the constructor function that initializes the {@link AuthorizationModule}.
   * 
  ...
  constructor(
    ...
    super(config, cache, handler || new RabbitMqReceiver(config, logger), sender || new RabbitMqSender(config, logger), EventGroup.Authorization, logger);
