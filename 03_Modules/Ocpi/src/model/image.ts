...
export interface Image { 
    ...
    category: Image.CategoryEnum;
    type: string;
    width?: number | null;
    height?: number | null;
}
export namespace Image {
    export type CategoryEnum = 'CHARGER' | 'ENTRANCE' | 'LOCATION' | 'NETWORK' | 'OPERATOR' | 'OTHER' | 'OWNER';
    export const CategoryEnum = {
        Charger: 'CHARGER' as CategoryEnum,
        Entrance: 'ENTRANCE' as CategoryEnum,
        Location: 'LOCATION' as CategoryEnum,
        Network: 'NETWORK' as CategoryEnum,
        Operator: 'OPERATOR' as CategoryEnum,
        Other: 'OTHER' as CategoryEnum,
        Owner: 'OWNER' as CategoryEnum
    };
}
