...
export interface OcpiResponseChargingPreferencesResponse { 
    status_code: number;
    status_message?: string;
    data?: OcpiResponseChargingPreferencesResponse.DataEnum;
    timestamp: string;
}
export namespace OcpiResponseChargingPreferencesResponse {
    export type DataEnum = 'ACCEPTED' | 'DEPARTURE_REQUIRED' | 'ENERGY_NEED_REQUIRED' | 'NOT_POSSIBLE' | 'PROFILE_TYPE_NOT_SUPPORTED';
    export const DataEnum = {
        Accepted: 'ACCEPTED' as DataEnum,
        DepartureRequired: 'DEPARTURE_REQUIRED' as DataEnum,
        EnergyNeedRequired: 'ENERGY_NEED_REQUIRED' as DataEnum,
        NotPossible: 'NOT_POSSIBLE' as DataEnum,
        ProfileTypeNotSupported: 'PROFILE_TYPE_NOT_SUPPORTED' as DataEnum
    };
}
