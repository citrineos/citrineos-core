...
export interface ChargingPreferences { 
    profile_type: ChargingPreferences.ProfileTypeEnum;
    departure_time?: string;
    energy_need?: number;
    discharge_allowed?: boolean;
}
export namespace ChargingPreferences {
    export type ProfileTypeEnum = 'CHEAP' | 'FAST' | 'GREEN' | 'REGULAR';
    export const ProfileTypeEnum = {
        Cheap: 'CHEAP' as ProfileTypeEnum,
        Fast: 'FAST' as ProfileTypeEnum,
        Green: 'GREEN' as ProfileTypeEnum,
        Regular: 'REGULAR' as ProfileTypeEnum
    };
}
