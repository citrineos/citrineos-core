...
export interface ChargingProfileResponse { 
    result: ChargingProfileResponse.ResultEnum;
    timeout: number;
}
export namespace ChargingProfileResponse {
    export type ResultEnum = 'ACCEPTED' | 'NOT_SUPPORTED' | 'REJECTED' | 'TOO_OFTEN' | 'UNKNOWN_SESSION';
    export const ResultEnum = {
        Accepted: 'ACCEPTED' as ResultEnum,
        NotSupported: 'NOT_SUPPORTED' as ResultEnum,
        Rejected: 'REJECTED' as ResultEnum,
        TooOften: 'TOO_OFTEN' as ResultEnum,
        UnknownSession: 'UNKNOWN_SESSION' as ResultEnum
    };
}
