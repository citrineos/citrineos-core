...
export interface CredentialsRole { 
    role: CredentialsRole.RoleEnum;
    business_details: BusinessDetails;
    party_id: string;
    country_code: string;
}
export namespace CredentialsRole {
    export type RoleEnum = 'CPO' | 'EMSP' | 'HUB' | 'NAP' | 'NSP' | 'OTHER' | 'SCSP';
    export const RoleEnum = {
        Cpo: 'CPO' as RoleEnum,
        Emsp: 'EMSP' as RoleEnum,
        Hub: 'HUB' as RoleEnum,
        Nap: 'NAP' as RoleEnum,
        Nsp: 'NSP' as RoleEnum,
        Other: 'OTHER' as RoleEnum,
        Scsp: 'SCSP' as RoleEnum
    };
}
