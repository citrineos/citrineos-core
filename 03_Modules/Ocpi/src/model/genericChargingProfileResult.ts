...
export interface GenericChargingProfileResult { 
    result: GenericChargingProfileResult.ResultEnum;
    profile?: ActiveChargingProfile;
}
export namespace GenericChargingProfileResult {
    export type ResultEnum = 'ACCEPTED' | 'REJECTED' | 'UNKNOWN';
    export const ResultEnum = {
        Accepted: 'ACCEPTED' as ResultEnum,
        Rejected: 'REJECTED' as ResultEnum,
        Unknown: 'UNKNOWN' as ResultEnum
    };
}
