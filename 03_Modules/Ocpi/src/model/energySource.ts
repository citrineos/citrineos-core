...
export interface EnergySource { 
    source: EnergySource.SourceEnum;
    percentage: number;
}
export namespace EnergySource {
    export type SourceEnum = 'NUCLEAR' | 'GENERAL_FOSSIL' | 'COAL' | 'GAS' | 'GENERAL_GREEN' | 'SOLAR' | 'WIND' | 'WATER';
    export const SourceEnum = {
        Nuclear: 'NUCLEAR' as SourceEnum,
        GeneralFossil: 'GENERAL_FOSSIL' as SourceEnum,
        Coal: 'COAL' as SourceEnum,
        Gas: 'GAS' as SourceEnum,
        GeneralGreen: 'GENERAL_GREEN' as SourceEnum,
        Solar: 'SOLAR' as SourceEnum,
        Wind: 'WIND' as SourceEnum,
        Water: 'WATER' as SourceEnum
    };
}
