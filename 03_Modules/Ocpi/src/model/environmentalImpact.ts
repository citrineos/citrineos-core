...
export interface EnvironmentalImpact { 
    category: EnvironmentalImpact.CategoryEnum;
    amount: number;
}
export namespace EnvironmentalImpact {
    export type CategoryEnum = 'NUCLEAR_WASTE' | 'CARBON_DIOXIDE';
    export const CategoryEnum = {
        NuclearWaste: 'NUCLEAR_WASTE' as CategoryEnum,
        CarbonDioxide: 'CARBON_DIOXIDE' as CategoryEnum
    };
}
