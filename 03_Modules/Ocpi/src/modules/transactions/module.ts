...
import {LocationsControllerApi, PutEvseRequest} from "../../apis/LocationsControllerApi";

/**
 * Component that handles transaction related messages.
 */
export class OcpiTransactionsModule extends AbstractModule {
    ...
    protected _handleStatusNotification(
        ...
        // todo get get/build evse object
        this.locationsControllerApi.putEvse(new PutEvseRequest());
    }
