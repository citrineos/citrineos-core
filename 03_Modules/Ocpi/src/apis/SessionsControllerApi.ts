...
export class SessionsControllerApi extends BaseAPI {
    ...
    async getSession(requestParameters: GetSessionRequest, versionId: string = VersionNumber.TWO_DOT_TWO_DOT_ONE): Promise<OcpiResponse<Session>> {
    ...
    async patchSession(requestParameters: PatchSessionRequest, versionId: string = VersionNumber.TWO_DOT_TWO_DOT_ONE): Promise<OcpiResponse<void>> {
    ...
    async putSession(requestParameters: PutSessionRequest, versionId: string = VersionNumber.TWO_DOT_TWO_DOT_ONE): Promise<OcpiResponse<void>> {
