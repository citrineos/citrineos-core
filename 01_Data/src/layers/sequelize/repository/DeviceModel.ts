...
export class SequelizeDeviceModelRepository extends SequelizeRepository<VariableAttribute> implements IDeviceModelRepository {
  ...
  async readAllByVAQuerystring(query: VariableAttributeQuerystring): Promise<VariableAttribute[]> {
  ...
  async existByVAQuerystring(query: VariableAttributeQuerystring): Promise<number> {
    return await super.existByQuery(this.constructQuery(query));
  }

  async deleteAllByVAQuerystring(query: VariableAttributeQuerystring): Promise<VariableAttribute[]> {
