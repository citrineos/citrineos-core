...
import { DEFAULT_TENANT_ID, OCPP2_0_1, OCPP2_1, OCPP2_0_1_Namespace } from '@citrineos/base';
import {
  BeforeCreate,
  BeforeUpdate,
  BelongsTo,
...
@Table
export class EventData extends Model implements OCPP2_1.EventDataType, EventDataDto {
