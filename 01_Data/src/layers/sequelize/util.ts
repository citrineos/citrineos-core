...
export class DefaultSequelizeInstance {
  ...
  private static defaultSequelize(config: SystemConfig, sync?: boolean, logger?: Logger<ILogObj>) {
    ...
    const sequelize: Sequelize = new Sequelize({
      ...
      models: [AdditionalInfo, Authorization, Boot, Component, ComponentVariable, Evse, IdToken, IdTokenInfo, MeterValue, SecurityEvent, Transaction, TransactionEvent, VariableAttribute, VariableCharacteristics, VariableStatus, Variable],
