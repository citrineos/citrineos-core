...
export { GenerateRootCertificatesSchema, InstallRootCertificateSchema } from './queries/RootCertificate';
...
export { GenerateRootCertificatesRequest } from './dtos/GenerateRootCertificatesRequest';
