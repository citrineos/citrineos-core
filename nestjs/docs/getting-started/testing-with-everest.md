...
<img src="../../assets/img/everest-failing.png" alt="Everest failing" style="max-width: 700px; width: 100%; height: auto;">
...
<img src="../../assets/img/disable-rosetta.png" alt="Disable Rosetta in Docker Desktop" style="max-width: 700px; width: 100%; height: auto;">

After disabling this checkbox, the `Syscall pipe2() failed` error should go away and you should be able to see Everest
start up successfully

<img src="../../assets/img/everest-running.png" alt="Everest running successfully" style="max-width: 700px; width: 100%; height: auto;">
