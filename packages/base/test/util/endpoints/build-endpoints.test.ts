...
import { AbstractEndpoint } from '@interfaces/api/endpoints/abstract-endpoint.js';
import {
  AbstractMessageEndpoint,
  type IMessageEndpointMetadata,
} from '@interfaces/api/endpoints/abstract-message-endpoint.js';
import { buildEndpoints } from '@base-util/endpoints/build-endpoints.js';
import type { EndpointClass, IEndpointBuilder } from '@interfaces/api/endpoints/build-endpoints.js';
import { buildMessageEndpoints } from '@base-util/endpoints/build-message-endpoints.js';
