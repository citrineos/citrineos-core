...
import { AbstractEndpointApi } from '@interfaces/api/endpoints/abstract-endpoint-api.js';
...
import { BadRequestError } from '@interfaces/api/exceptions/bad-request-error.js';
import { NotFoundError } from '@interfaces/api/exceptions/not-found-error.js';
