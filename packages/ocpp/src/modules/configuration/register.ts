...
import {
  ...
  PublishFirmwareStatusNotificationRequestOcpp2Handler,
...
import { BootNotificationService } from './boot-notification-service.js';
import { DeviceModelService } from './device-model-service.js';
