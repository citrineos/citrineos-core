...
import type { BootNotificationService } from '@modules/Configuration/BootNotificationService.js';
import type { DeviceModelService } from '@modules/Configuration/DeviceModelService.js';
