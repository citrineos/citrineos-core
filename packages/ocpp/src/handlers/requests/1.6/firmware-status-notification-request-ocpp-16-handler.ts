...
@AsRequestHandler([OCPPVersion.OCPP1_6], OCPP_CallAction.FirmwareStatusNotification)
export class FirmwareStatusNotificationRequestOcpp16Handler extends AbstractHandler {
