...
import { RabbitMQChannelManager } from '@/transport/queue/rabbit-mq/ChannelManager.js';
import { RabbitMQConnectionManager } from '@/transport/queue/rabbit-mq/ConnectionManager.js';
