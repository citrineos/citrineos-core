...
import { ChangeConfigurationEndpoint } from '@/apis/ocpp/1.6/configuration/change-configuration-endpoint.js';
import { GetConfigurationEndpoint } from '@/apis/ocpp/1.6/configuration/get-configuration-endpoint.js';
import { SetDisplayMessageEndpoint } from '@/apis/ocpp/2/configuration/set-display-message-endpoint.js';
import { TriggerMessageEndpoint as TriggerMessage16Endpoint } from '@/apis/ocpp/1.6/configuration/trigger-message-endpoint.js';
