...
import { CancelReservationEndpoint } from '@/apis/ocpp/2/ev-driver/cancel-reservation-endpoint.js';
import { RequestStartTransactionEndpoint } from '@/apis/ocpp/2/ev-driver/request-start-transaction-endpoint.js';
import { ReserveNowEndpoint } from '@/apis/ocpp/2/ev-driver/reserve-now-endpoint.js';
import { SendLocalListEndpoint as SendLocalList16Endpoint } from '@/apis/ocpp/1.6/ev-driver/send-local-list-endpoint.js';
import { SendLocalListEndpoint } from '@/apis/ocpp/2/ev-driver/send-local-list-endpoint.js';
