...
import { ClearVariableMonitoringEndpoint } from '@/apis/ocpp/2/monitoring/clear-variable-monitoring-endpoint.js';
import { GetVariablesEndpoint } from '@/apis/ocpp/2/monitoring/get-variables-endpoint.js';
import { SetVariableMonitoringEndpoint } from '@/apis/ocpp/2/monitoring/set-variable-monitoring-endpoint.js';
import { SetVariablesEndpoint } from '@/apis/ocpp/2/monitoring/set-variables-endpoint.js';
