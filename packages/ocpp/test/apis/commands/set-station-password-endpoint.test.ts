...
import { SetStationPasswordEndpoint } from '@/apis/commands/set-station-password-endpoint.js';
...
describe('SetStationPasswordEndpoint', () => {
  ...
  describe('setOnCharger semantics', () => {
    ...
    it('does not look up the station when the password is already set on it', async () => {
      ...
      expect(readChargingStationByOcppConnectionName).not.toHaveBeenCalled();
    });
