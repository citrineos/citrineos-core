...
These files are generated by our generating certificate api below. The generated files are stored in the fileAccess storage.

```
curl --location 'http://localhost:8080/ocpprouter/certificateChain' \
