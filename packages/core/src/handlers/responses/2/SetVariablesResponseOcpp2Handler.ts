...
import { AttributeEnum, type AttributeEnumType, type HandlerProperties, MessageOrigin, OCPP_2_VER_LIST, OCPP_CallAction, SetVariableStatusEnum } from '@citrineos/types';
import {
  Component,
