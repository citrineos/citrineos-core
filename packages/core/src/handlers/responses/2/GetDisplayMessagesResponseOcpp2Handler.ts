...
@AsResponseHandler(OCPP_2_VER_LIST, OCPP_CallAction.GetDisplayMessages)
export class GetDisplayMessagesResponseOcpp2Handler extends AbstractHandler {
  ...
  async handle(
    ...
    this._logger.debug(
      this.createHandlerReceivedMessageLog('GetDisplayMessagesResponse'),
      message,
      props,
    );
  }
