...
import { ChargingStationSequenceTypeEnum, ClearMessageStatusEnum, type ClearMessageStatusEnumType, EventGroup, type HandlerProperties, OCPP_2_VER_LIST, OCPP_CallAction } from '@citrineos/types';
