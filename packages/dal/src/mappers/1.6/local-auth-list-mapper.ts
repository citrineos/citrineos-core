...
import type { Authorization } from '../../models/authorization/authorization.js';
import type { LocalListAuthorization } from '../../models/authorization/local-list-authorization.js';
