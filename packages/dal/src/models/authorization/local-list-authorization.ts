...
import { type AuthorizationRestrictions } from '@dal/interfaces/projections/authorization-restrictions.js';
import { Tenant } from '../tenant.js';
import { Authorization } from './authorization.js';
import { SendLocalList } from './send-local-list.js';
import { SendLocalListAuthorization } from './send-local-list-authorization.js';
import { LocalListVersion } from './local-list-version.js';
import { LocalListVersionAuthorization } from './local-list-version-authorization.js';
