...
import type { PaginatedParams } from './param/paginated-params.js';
import type { PaginatedTokenResponse } from '../../types/dto/token-dto.js';
import { PaginatedTokenResponseSchema } from '../../types/dto/token-dto.js';
import { TokenType } from '../../types/token-type.js';
import type { LocationReferences } from '../../types/location-references.js';
import type { AuthorizationInfoResponse } from '../../types/authorization-info.js';
import { AuthorizationInfoResponseSchema } from '../../types/authorization-info.js';
