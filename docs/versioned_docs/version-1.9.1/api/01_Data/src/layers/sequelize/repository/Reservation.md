...
[CitrineOS Core](../../../../../index.md) / 01_Data/src/layers/sequelize/repository/Reservation

# 01_Data/src/layers/sequelize/repository/Reservation

## Classes

### SequelizeReservationRepository

Defined in: [01_Data/src/layers/sequelize/repository/Reservation.ts:13](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/Reservation.ts#L13)

#### Extends

- [`SequelizeRepository`](Base.md#sequelizerepository)\<[`Reservation`](../model/Reservation.md#reservation)\>

#### Implements

- [`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository)
...
new SequelizeReservationRepository(
   ...
   logger?,
   sequelizeInstance?,
   evse?): SequelizeReservationRepository;
```

Defined in: [01_Data/src/layers/sequelize/repository/Reservation.ts:20](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/Reservation.ts#L20)
...
[`SequelizeReservationRepository`](#sequelizereservationrepository)
...
| ---------------------------------- | ----------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="evse"></a> `evse`           | `public`    | `CrudRepository`\<[`EvseType`](../model/DeviceModel/EvseType.md#evsetype)\> | -                                                                               | -                                                                                     | [01_Data/src/layers/sequelize/repository/Reservation.ts:17](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/Reservation.ts#L17) |
| <a id="logger"></a> `logger`       | `public`    | `Logger`\<`ILogObj`\>                                                       | [`SequelizeRepository`](Base.md#sequelizerepository).[`logger`](Base.md#logger) | -                                                                                     | [01_Data/src/layers/sequelize/repository/Reservation.ts:18](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/Reservation.ts#L18) |
...
| ----------- | ------------------------------------------------------ |
| `tenantId`  | `number`                                               |
| `values`    | [`Reservation`](../model/Reservation.md#reservation)[] |
| `namespace` | `string`                                               |

###### Returns

`Promise`\<[`Reservation`](../model/Reservation.md#reservation)[]\>

###### Implementation of

[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`_bulkCreate`](../../../interfaces/repositories.md#_bulkcreate-15)
...
protected _create(
   tenantId,
   value,
_namespace?): Promise<Reservation>;
```
...
| ------------ | ---------------------------------------------------- |
| `tenantId`   | `number`                                             |
| `value`      | [`Reservation`](../model/Reservation.md#reservation) |
| `_namespace` | `string`                                             |
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`_create`](../../../interfaces/repositories.md#_create-15)
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`_createByKey`](../../../interfaces/repositories.md#_createbykey-15)
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`_deleteAllByQuery`](../../../interfaces/repositories.md#_deleteallbyquery-15)
...
protected _deleteByKey(
   tenantId,
   key,
namespace?): Promise<Reservation | undefined>;
```
...
`Promise`\<[`Reservation`](../model/Reservation.md#reservation) \| `undefined`\>

###### Implementation of

[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`_deleteByKey`](../../../interfaces/repositories.md#_deletebykey-15)
...
`Promise`\<\[[`Reservation`](../model/Reservation.md#reservation), `boolean`\]\>

###### Implementation of

[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`_readOrCreateByQuery`](../../../interfaces/repositories.md#_readorcreatebyquery-15)
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`_updateAllByQuery`](../../../interfaces/repositories.md#_updateallbyquery-15)
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`_updateByKey`](../../../interfaces/repositories.md#_updatebykey-15)
...
| `values`     | [`Reservation`](../model/Reservation.md#reservation)[] | The values of the entries.                       |
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`bulkCreate`](../../../interfaces/repositories.md#bulkcreate-15)
...
| `value`      | [`Reservation`](../model/Reservation.md#reservation) | The value of the entry.                        |
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`create`](../../../interfaces/repositories.md#create-15)
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`createByKey`](../../../interfaces/repositories.md#createbykey-15)
...
createOrUpdateReservation(
   ...
   reserveNowRequest,
   stationId,
isActive?): Promise<Reservation | undefined>;
```

Defined in: [01_Data/src/layers/sequelize/repository/Reservation.ts:36](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/Reservation.ts#L36)
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`createOrUpdateReservation`](../../../interfaces/repositories.md#createorupdatereservation)
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`deleteAllByQuery`](../../../interfaces/repositories.md#deleteallbyquery-15)
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`deleteByKey`](../../../interfaces/repositories.md#deletebykey-15)
...
| ...`args` | `CrudEvent`\<[`Reservation`](../model/Reservation.md#reservation)\>\[`K`\] | The arguments to pass with the event. Allowed types correspond to the contents of the event key in CrudEvent. |
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`emit`](../../../interfaces/repositories.md#emit-15)
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`existByQuery`](../../../interfaces/repositories.md#existbyquery-15)
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`existsByKey`](../../../interfaces/repositories.md#existsbykey-15)
...
`Promise`\<\{
`count`: `number`;
`rows`: [`Reservation`](../model/Reservation.md#reservation)[];
\}\>
...
```ts
getNextReservationId(tenantId, stationId): Promise<number>;
```

Defined in: [01_Data/src/layers/sequelize/repository/Reservation.ts:92](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/Reservation.ts#L92)
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`on`](../../../interfaces/repositories.md#on-15)
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`readAllByQuery`](../../../interfaces/repositories.md#readallbyquery-15)
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`readByKey`](../../../interfaces/repositories.md#readbykey-15)
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`readNextValue`](../../../interfaces/repositories.md#readnextvalue-15)
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`readOnlyOneByQuery`](../../../interfaces/repositories.md#readonlyonebyquery-15)
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`readOrCreateByQuery`](../../../interfaces/repositories.md#readorcreatebyquery-15)
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`updateAllByQuery`](../../../interfaces/repositories.md#updateallbyquery-15)
...
[`IReservationRepository`](../../../interfaces/repositories.md#ireservationrepository).[`updateByKey`](../../../interfaces/repositories.md#updatebykey-15)
