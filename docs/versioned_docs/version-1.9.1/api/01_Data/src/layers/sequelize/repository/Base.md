...
[CitrineOS Core](../../../../../index.md) / 01_Data/src/layers/sequelize/repository/Base

# 01_Data/src/layers/sequelize/repository/Base

## Classes

### SequelizeRepository

Defined in: [01_Data/src/layers/sequelize/repository/Base.ts:19](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/Base.ts#L19)
...
- [`SequelizeAsyncJobStatusRepository`](AsyncJobStatus.md#sequelizeasyncjobstatusrepository)
- [`SequelizeAuthorizationRepository`](Authorization.md#sequelizeauthorizationrepository)
- [`SequelizeBootRepository`](Boot.md#sequelizebootrepository)
- [`SequelizeCertificateRepository`](Certificate.md#sequelizecertificaterepository)
- [`SequelizeChangeConfigurationRepository`](ChangeConfiguration.md#sequelizechangeconfigurationrepository)
- [`SequelizeChargingProfileRepository`](ChargingProfile.md#sequelizechargingprofilerepository)
- [`SequelizeChargingStationSecurityInfoRepository`](ChargingStationSecurityInfo.md#sequelizechargingstationsecurityinforepository)
- [`SequelizeChargingStationSequenceRepository`](ChargingStationSequence.md#sequelizechargingstationsequencerepository)
- [`SequelizeDeleteCertificateAttemptRepository`](DeleteCertificateAttempt.md#sequelizedeletecertificateattemptrepository)
- [`SequelizeDeviceModelRepository`](DeviceModel.md#sequelizedevicemodelrepository)
- [`SequelizeInstallCertificateAttemptRepository`](InstallCertificateAttempt.md#sequelizeinstallcertificateattemptrepository)
- [`SequelizeInstalledCertificateRepository`](InstalledCertificate.md#sequelizeinstalledcertificaterepository)
- [`SequelizeLocalAuthListRepository`](LocalAuthList.md#sequelizelocalauthlistrepository)
- [`SequelizeLocationRepository`](Location.md#sequelizelocationrepository)
- [`SequelizeMessageInfoRepository`](MessageInfo.md#sequelizemessageinforepository)
- [`SequelizeOCPPMessageRepository`](OCPPMessage.md#sequelizeocppmessagerepository)
- [`SequelizeReservationRepository`](Reservation.md#sequelizereservationrepository)
- [`SequelizeSecurityEventRepository`](SecurityEvent.md#sequelizesecurityeventrepository)
- [`SequelizeServerNetworkProfileRepository`](ServerNetworkProfile.md#sequelizeservernetworkprofilerepository)
- [`SequelizeSubscriptionRepository`](Subscription.md#sequelizesubscriptionrepository)
- [`SequelizeTariffRepository`](Tariff.md#sequelizetariffrepository)
- [`SequelizeTenantRepository`](Tenant.md#sequelizetenantrepository)
- [`SequelizeTransactionEventRepository`](TransactionEvent.md#sequelizetransactioneventrepository)
- [`SequelizeVariableMonitoringRepository`](VariableMonitoring.md#sequelizevariablemonitoringrepository)

#### Type Parameters

| Type Parameter                        |
| ------------------------------------- |
| `T` _extends_ `Model`\<`any`, `any`\> |
...
```ts
new SequelizeRepository<T>(
   config,
   namespace,
   logger?,
sequelizeInstance?): SequelizeRepository<T>;
```

Defined in: [01_Data/src/layers/sequelize/repository/Base.ts:24](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/Base.ts#L24)
...
[`SequelizeRepository`](#sequelizerepository)\<`T`\>

###### Overrides

```ts
CrudRepository<T>.constructor
```
...
| ---------------------------------- | ----------- | --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="logger"></a> `logger`       | `protected` | `Logger`\<`ILogObj`\> | [01_Data/src/layers/sequelize/repository/Base.ts:22](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/Base.ts#L22) |
| <a id="namespace"></a> `namespace` | `protected` | `string`              | [01_Data/src/layers/sequelize/repository/Base.ts:21](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/Base.ts#L21) |
| <a id="s"></a> `s`                 | `protected` | `Sequelize`           | [01_Data/src/layers/sequelize/repository/Base.ts:20](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/Base.ts#L20) |
...
| ...`args` | `CrudEvent`\<`T`\>\[`K`\] | The arguments to pass with the event. Allowed types correspond to the contents of the event key in CrudEvent. |
