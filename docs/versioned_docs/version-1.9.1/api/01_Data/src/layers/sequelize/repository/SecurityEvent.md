...
[CitrineOS Core](../../../../../index.md) / 01_Data/src/layers/sequelize/repository/SecurityEvent

# 01_Data/src/layers/sequelize/repository/SecurityEvent

## Classes

### SequelizeSecurityEventRepository

Defined in: [01_Data/src/layers/sequelize/repository/SecurityEvent.ts:14](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/SecurityEvent.ts#L14)

#### Extends

- [`SequelizeRepository`](Base.md#sequelizerepository)\<[`SecurityEvent`](../model/SecurityEvent.md#securityevent)\>

#### Implements

- [`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository)
...
```ts
new SequelizeSecurityEventRepository(
   config,
   logger?,
   sequelizeInstance?): SequelizeSecurityEventRepository;
```

Defined in: [01_Data/src/layers/sequelize/repository/SecurityEvent.ts:18](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/SecurityEvent.ts#L18)
...
[`SequelizeSecurityEventRepository`](#sequelizesecurityeventrepository)
...
| ----------- | ------------------------------------------------------------ |
| `tenantId`  | `number`                                                     |
| `values`    | [`SecurityEvent`](../model/SecurityEvent.md#securityevent)[] |
| `namespace` | `string`                                                     |

###### Returns

`Promise`\<[`SecurityEvent`](../model/SecurityEvent.md#securityevent)[]\>

###### Implementation of

[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`_bulkCreate`](../../../interfaces/repositories.md#_bulkcreate-16)
...
protected _create(
   tenantId,
   value,
_namespace?): Promise<SecurityEvent>;
```
...
| ------------ | ---------------------------------------------------------- |
| `tenantId`   | `number`                                                   |
| `value`      | [`SecurityEvent`](../model/SecurityEvent.md#securityevent) |
| `_namespace` | `string`                                                   |
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`_create`](../../../interfaces/repositories.md#_create-16)
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`_createByKey`](../../../interfaces/repositories.md#_createbykey-16)
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`_deleteAllByQuery`](../../../interfaces/repositories.md#_deleteallbyquery-16)
...
protected _deleteByKey(
   tenantId,
   key,
namespace?): Promise<SecurityEvent | undefined>;
```
...
`Promise`\<[`SecurityEvent`](../model/SecurityEvent.md#securityevent) \| `undefined`\>

###### Implementation of

[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`_deleteByKey`](../../../interfaces/repositories.md#_deletebykey-16)
...
`Promise`\<\[[`SecurityEvent`](../model/SecurityEvent.md#securityevent), `boolean`\]\>

###### Implementation of

[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`_readOrCreateByQuery`](../../../interfaces/repositories.md#_readorcreatebyquery-16)
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`_updateAllByQuery`](../../../interfaces/repositories.md#_updateallbyquery-16)
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`_updateByKey`](../../../interfaces/repositories.md#_updatebykey-16)
...
| `values`     | [`SecurityEvent`](../model/SecurityEvent.md#securityevent)[] | The values of the entries.                       |
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`bulkCreate`](../../../interfaces/repositories.md#bulkcreate-16)
...
| `value`      | [`SecurityEvent`](../model/SecurityEvent.md#securityevent) | The value of the entry.                        |
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`create`](../../../interfaces/repositories.md#create-16)
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`createByKey`](../../../interfaces/repositories.md#createbykey-16)
...
createByStationId(
   tenantId,
   value,
stationId): Promise<SecurityEvent>;
```

Defined in: [01_Data/src/layers/sequelize/repository/SecurityEvent.ts:22](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/SecurityEvent.ts#L22)
...
| ----------- | ---------------------------------- |
| `tenantId`  | `number`                           |
| `value`     | `SecurityEventNotificationRequest` |
| `stationId` | `string`                           |
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`createByStationId`](../../../interfaces/repositories.md#createbystationid)
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`deleteAllByQuery`](../../../interfaces/repositories.md#deleteallbyquery-16)
...
```ts
deleteByKey(tenantId, key): Promise<SecurityEvent | undefined>;
```

Defined in: [01_Data/src/layers/sequelize/repository/SecurityEvent.ts:52](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/SecurityEvent.ts#L52)
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`deleteByKey`](../../../interfaces/repositories.md#deletebykey-16)
...
| ...`args` | `CrudEvent`\<[`SecurityEvent`](../model/SecurityEvent.md#securityevent)\>\[`K`\] | The arguments to pass with the event. Allowed types correspond to the contents of the event key in CrudEvent. |
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`emit`](../../../interfaces/repositories.md#emit-16)
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`existByQuery`](../../../interfaces/repositories.md#existbyquery-16)
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`existsByKey`](../../../interfaces/repositories.md#existsbykey-16)
...
`Promise`\<\{
`count`: `number`;
`rows`: [`SecurityEvent`](../model/SecurityEvent.md#securityevent)[];
\}\>
...
```ts
private generateTimestampQuery(from?, to?): any;
```

Defined in: [01_Data/src/layers/sequelize/repository/SecurityEvent.ts:59](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/SecurityEvent.ts#L59)
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`on`](../../../interfaces/repositories.md#on-16)
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`readAllByQuery`](../../../interfaces/repositories.md#readallbyquery-16)
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`readByKey`](../../../interfaces/repositories.md#readbykey-16)
...
readByStationIdAndTimestamps(
   ...
   stationId,
   from?,
to?): Promise<SecurityEvent[]>;
```

Defined in: [01_Data/src/layers/sequelize/repository/SecurityEvent.ts:37](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/SecurityEvent.ts#L37)
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`readByStationIdAndTimestamps`](../../../interfaces/repositories.md#readbystationidandtimestamps)
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`readNextValue`](../../../interfaces/repositories.md#readnextvalue-16)
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`readOnlyOneByQuery`](../../../interfaces/repositories.md#readonlyonebyquery-16)
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`readOrCreateByQuery`](../../../interfaces/repositories.md#readorcreatebyquery-16)
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`updateAllByQuery`](../../../interfaces/repositories.md#updateallbyquery-16)
...
[`ISecurityEventRepository`](../../../interfaces/repositories.md#isecurityeventrepository).[`updateByKey`](../../../interfaces/repositories.md#updatebykey-16)
