...
[CitrineOS Core](../../../../../index.md) / 01_Data/src/layers/sequelize/repository/Subscription

# 01_Data/src/layers/sequelize/repository/Subscription

## Classes

### SequelizeSubscriptionRepository

Defined in: [01_Data/src/layers/sequelize/repository/Subscription.ts:12](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/Subscription.ts#L12)

#### Extends

- [`SequelizeRepository`](Base.md#sequelizerepository)\<[`Subscription`](../model/Subscription/Subscription.md#subscription)\>

#### Implements

- [`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository)
...
new SequelizeSubscriptionRepository(
   config,
   logger?,
   sequelizeInstance?): SequelizeSubscriptionRepository;
```

Defined in: [01_Data/src/layers/sequelize/repository/Subscription.ts:16](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/Subscription.ts#L16)
...
[`SequelizeSubscriptionRepository`](#sequelizesubscriptionrepository)
...
| ----------- | ---------------------------------------------------------------------- |
| `tenantId`  | `number`                                                               |
| `values`    | [`Subscription`](../model/Subscription/Subscription.md#subscription)[] |
| `namespace` | `string`                                                               |

###### Returns

`Promise`\<[`Subscription`](../model/Subscription/Subscription.md#subscription)[]\>

###### Implementation of

[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`_bulkCreate`](../../../interfaces/repositories.md#_bulkcreate-18)
...
protected _create(
   tenantId,
   value,
_namespace?): Promise<Subscription>;
```
...
| ------------ | -------------------------------------------------------------------- |
| `tenantId`   | `number`                                                             |
| `value`      | [`Subscription`](../model/Subscription/Subscription.md#subscription) |
| `_namespace` | `string`                                                             |
...
[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`_create`](../../../interfaces/repositories.md#_create-18)
...
[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`_createByKey`](../../../interfaces/repositories.md#_createbykey-18)
...
[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`_deleteAllByQuery`](../../../interfaces/repositories.md#_deleteallbyquery-18)
...
`Promise`\<
\| [`Subscription`](../model/Subscription/Subscription.md#subscription)
\| `undefined`\>

###### Implementation of

[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`_deleteByKey`](../../../interfaces/repositories.md#_deletebykey-18)
...
`Promise`\<\[[`Subscription`](../model/Subscription/Subscription.md#subscription), `boolean`\]\>

###### Implementation of

[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`_readOrCreateByQuery`](../../../interfaces/repositories.md#_readorcreatebyquery-18)
...
[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`_updateAllByQuery`](../../../interfaces/repositories.md#_updateallbyquery-18)
...
[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`_updateByKey`](../../../interfaces/repositories.md#_updatebykey-18)
...
| `values`     | [`Subscription`](../model/Subscription/Subscription.md#subscription)[] | The values of the entries.                       |
...
[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`bulkCreate`](../../../interfaces/repositories.md#bulkcreate-18)
...
Defined in: [01_Data/src/layers/sequelize/repository/Subscription.ts:28](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/Subscription.ts#L28)

Creates a new [Subscription](../model/Subscription/Subscription.md#subscription) in the database.
Input is assumed to not have an id, and id will be removed if present.
Object is rebuilt to ensure access to essential Model function Model.save() (Model is extended by Subscription).
...
| ---------- | -------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| `tenantId` | `number`                                                             | -                                                                                                                    |
| `value`    | [`Subscription`](../model/Subscription/Subscription.md#subscription) | [Subscription](../model/Subscription/Subscription.md#subscription) object which may have been deserialized from JSON |

###### Returns

`Promise`\<[`Subscription`](../model/Subscription/Subscription.md#subscription)\>

Saved [Subscription](../model/Subscription/Subscription.md#subscription) if successful, undefined otherwise

###### Implementation of

[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`create`](../../../interfaces/repositories.md#create-18)
...
| `value`      | [`Subscription`](../model/Subscription/Subscription.md#subscription) | The value of the entry.                        |
...
[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`createByKey`](../../../interfaces/repositories.md#createbykey-18)
...
[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`deleteAllByQuery`](../../../interfaces/repositories.md#deleteallbyquery-18)
...
Defined in: [01_Data/src/layers/sequelize/repository/Subscription.ts:39](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/Subscription.ts#L39)
...
[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`deleteByKey`](../../../interfaces/repositories.md#deletebykey-18)
...
| ...`args` | `CrudEvent`\<[`Subscription`](../model/Subscription/Subscription.md#subscription)\>\[`K`\] | The arguments to pass with the event. Allowed types correspond to the contents of the event key in CrudEvent. |
...
[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`emit`](../../../interfaces/repositories.md#emit-18)
...
[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`existByQuery`](../../../interfaces/repositories.md#existbyquery-18)
...
[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`existsByKey`](../../../interfaces/repositories.md#existsbykey-18)
...
`Promise`\<\{
`count`: `number`;
`rows`: [`Subscription`](../model/Subscription/Subscription.md#subscription)[];
\}\>
...
[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`on`](../../../interfaces/repositories.md#on-18)
...
[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`readAllByQuery`](../../../interfaces/repositories.md#readallbyquery-18)
...
Defined in: [01_Data/src/layers/sequelize/repository/Subscription.ts:35](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/Subscription.ts#L35)
...
[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`readAllByStationId`](../../../interfaces/repositories.md#readallbystationid)
...
[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`readByKey`](../../../interfaces/repositories.md#readbykey-18)
...
[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`readNextValue`](../../../interfaces/repositories.md#readnextvalue-18)
...
[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`readOnlyOneByQuery`](../../../interfaces/repositories.md#readonlyonebyquery-18)
...
[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`readOrCreateByQuery`](../../../interfaces/repositories.md#readorcreatebyquery-18)
...
[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`updateAllByQuery`](../../../interfaces/repositories.md#updateallbyquery-18)
...
[`ISubscriptionRepository`](../../../interfaces/repositories.md#isubscriptionrepository).[`updateByKey`](../../../interfaces/repositories.md#updatebykey-18)
