...
[CitrineOS Core](../../../../../index.md) / 01_Data/src/layers/sequelize/repository/Tenant

# 01_Data/src/layers/sequelize/repository/Tenant

## Classes

### SequelizeTenantRepository

Defined in: [01_Data/src/layers/sequelize/repository/Tenant.ts:13](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/Tenant.ts#L13)

#### Extends

- [`SequelizeRepository`](Base.md#sequelizerepository)\<[`Tenant`](../model/Tenant.md#tenant)\>

#### Implements

- [`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository)
...
```ts
new SequelizeTenantRepository(
   config,
   logger?,
   sequelizeInstance?): SequelizeTenantRepository;
```

Defined in: [01_Data/src/layers/sequelize/repository/Tenant.ts:17](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/Tenant.ts#L17)
...
[`SequelizeTenantRepository`](#sequelizetenantrepository)
...
| ----------- | --------------------------------------- |
| `tenantId`  | `number`                                |
| `values`    | [`Tenant`](../model/Tenant.md#tenant)[] |
| `namespace` | `string`                                |

###### Returns

`Promise`\<[`Tenant`](../model/Tenant.md#tenant)[]\>

###### Implementation of

[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`_bulkCreate`](../../../interfaces/repositories.md#_bulkcreate-20)
...
| ------------ | ------------------------------------- |
| `tenantId`   | `number`                              |
| `value`      | [`Tenant`](../model/Tenant.md#tenant) |
| `_namespace` | `string`                              |
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`_create`](../../../interfaces/repositories.md#_create-20)
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`_createByKey`](../../../interfaces/repositories.md#_createbykey-20)
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`_deleteAllByQuery`](../../../interfaces/repositories.md#_deleteallbyquery-20)
...
`Promise`\<[`Tenant`](../model/Tenant.md#tenant) \| `undefined`\>

###### Implementation of

[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`_deleteByKey`](../../../interfaces/repositories.md#_deletebykey-20)
...
`Promise`\<\[[`Tenant`](../model/Tenant.md#tenant), `boolean`\]\>

###### Implementation of

[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`_readOrCreateByQuery`](../../../interfaces/repositories.md#_readorcreatebyquery-20)
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`_updateAllByQuery`](../../../interfaces/repositories.md#_updateallbyquery-20)
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`_updateByKey`](../../../interfaces/repositories.md#_updatebykey-20)
...
| `values`     | [`Tenant`](../model/Tenant.md#tenant)[] | The values of the entries.                       |
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`bulkCreate`](../../../interfaces/repositories.md#bulkcreate-20)
...
| `value`      | [`Tenant`](../model/Tenant.md#tenant) | The value of the entry.                        |
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`create`](../../../interfaces/repositories.md#create-20)
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`createByKey`](../../../interfaces/repositories.md#createbykey-20)
...
Defined in: [01_Data/src/layers/sequelize/repository/Tenant.ts:21](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/01_Data/src/layers/sequelize/repository/Tenant.ts#L21)

###### Parameters

| Parameter | Type                                  |
| --------- | ------------------------------------- |
| `tenant`  | [`Tenant`](../model/Tenant.md#tenant) |
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`createTenant`](../../../interfaces/repositories.md#createtenant)
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`deleteAllByQuery`](../../../interfaces/repositories.md#deleteallbyquery-20)
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`deleteByKey`](../../../interfaces/repositories.md#deletebykey-20)
...
| ...`args` | `CrudEvent`\<[`Tenant`](../model/Tenant.md#tenant)\>\[`K`\] | The arguments to pass with the event. Allowed types correspond to the contents of the event key in CrudEvent. |
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`emit`](../../../interfaces/repositories.md#emit-20)
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`existByQuery`](../../../interfaces/repositories.md#existbyquery-20)
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`existsByKey`](../../../interfaces/repositories.md#existsbykey-20)
...
`Promise`\<\{
`count`: `number`;
`rows`: [`Tenant`](../model/Tenant.md#tenant)[];
\}\>
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`on`](../../../interfaces/repositories.md#on-20)
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`readAllByQuery`](../../../interfaces/repositories.md#readallbyquery-20)
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`readByKey`](../../../interfaces/repositories.md#readbykey-20)
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`readNextValue`](../../../interfaces/repositories.md#readnextvalue-20)
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`readOnlyOneByQuery`](../../../interfaces/repositories.md#readonlyonebyquery-20)
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`readOrCreateByQuery`](../../../interfaces/repositories.md#readorcreatebyquery-20)
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`updateAllByQuery`](../../../interfaces/repositories.md#updateallbyquery-20)
...
[`ITenantRepository`](../../../interfaces/repositories.md#itenantrepository).[`updateByKey`](../../../interfaces/repositories.md#updatebykey-20)
