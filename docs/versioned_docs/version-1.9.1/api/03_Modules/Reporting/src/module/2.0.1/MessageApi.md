...
[CitrineOS Core](../../../../../index.md) / 03_Modules/Reporting/src/module/2.0.1/MessageApi

# 03_Modules/Reporting/src/module/2.0.1/MessageApi

## Classes

### ReportingOcpp201Api

Defined in: [03_Modules/Reporting/src/module/2.0.1/MessageApi.ts:24](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/03_Modules/Reporting/src/module/2.0.1/MessageApi.ts#L24)
...
```ts
new ReportingOcpp201Api(
   reportingModule,
   server,
   logger?): ReportingOcpp201Api;
```

Defined in: [03_Modules/Reporting/src/module/2.0.1/MessageApi.ts:37](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/03_Modules/Reporting/src/module/2.0.1/MessageApi.ts#L37)
...
[`ReportingOcpp201Api`](#reportingocpp201api)
...
| ------------------------------------------------------------------ | ----------- | ---------------------------------------------------------------------- | ------------------- | ---------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="_componentdevicedatactrlr"></a> `_componentDeviceDataCtrlr` | `private`   | `"DeviceDataCtrlr"`                                                    | `'DeviceDataCtrlr'` | -                                  | [03_Modules/Reporting/src/module/2.0.1/MessageApi.ts:28](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/03_Modules/Reporting/src/module/2.0.1/MessageApi.ts#L28) |
...
| <a id="_module"></a> `_module`                                     | `readonly`  | [`ReportingModule`](../module.md#reportingmodule)                      | `undefined`         | `AbstractModuleApi._module`        | 00_Base/dist/interfaces/api/AbstractModuleApi.d.ts:16                                                                                                                                                       |
...
Defined in: [03_Modules/Reporting/src/module/2.0.1/MessageApi.ts:267](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/03_Modules/Reporting/src/module/2.0.1/MessageApi.ts#L267)
...
Defined in: [03_Modules/Reporting/src/module/2.0.1/MessageApi.ts:241](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/03_Modules/Reporting/src/module/2.0.1/MessageApi.ts#L241)
...
| `request`      | `CustomerInformationRequest` | `undefined`         |
...
Defined in: [03_Modules/Reporting/src/module/2.0.1/MessageApi.ts:42](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/03_Modules/Reporting/src/module/2.0.1/MessageApi.ts#L42)
...
| -------------- | ---------------------- | ------------------- |
| `identifier`   | `string`[]             | `undefined`         |
| `request`      | `GetBaseReportRequest` | `undefined`         |
| `callbackUrl?` | `string`               | `undefined`         |
| `tenantId?`    | `number`               | `DEFAULT_TENANT_ID` |
...
Defined in: [03_Modules/Reporting/src/module/2.0.1/MessageApi.ts:63](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/03_Modules/Reporting/src/module/2.0.1/MessageApi.ts#L63)
...
| -------------- | ------------------ | ------------------- |
| `identifier`   | `string`           | `undefined`         |
| `request`      | `GetReportRequest` | `undefined`         |
| `callbackUrl?` | `string`           | `undefined`         |
| `tenantId?`    | `number`           | `DEFAULT_TENANT_ID` |
...
Defined in: [03_Modules/Reporting/src/module/2.0.1/MessageApi.ts:218](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/03_Modules/Reporting/src/module/2.0.1/MessageApi.ts#L218)
...
| -------------- | --------------- | ------------------- |
| `identifier`   | `string`[]      | `undefined`         |
| `request`      | `GetLogRequest` | `undefined`         |
| `callbackUrl?` | `string`        | `undefined`         |
| `tenantId?`    | `number`        | `DEFAULT_TENANT_ID` |
...
Defined in: [03_Modules/Reporting/src/module/2.0.1/MessageApi.ts:149](https://github.com/citrineos/citrineos-core/blob/def27d2c18695e68d1cb53d23c8d4cfb26151d5f/03_Modules/Reporting/src/module/2.0.1/MessageApi.ts#L149)
...
| -------------- | ---------------------------- | ------------------- |
| `identifier`   | `string`                     | `undefined`         |
| `request`      | `GetMonitoringReportRequest` | `undefined`         |
| `callbackUrl?` | `string`                     | `undefined`         |
| `tenantId?`    | `number`                     | `DEFAULT_TENANT_ID` |
