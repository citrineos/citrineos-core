...
import type { AdditionalInfo, IBaseDto, ITenantPartnerDto } from '../../index.js';
import { AuthorizationStatusType, AuthorizationWhitelistType, IdTokenType } from './enum/index.js';
